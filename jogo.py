...
saida = {'titulo': 'nao_encontrado', 'nivel': 'nao_encontrado', 'opcoes': 'nao_encontrado', 'correta': 'nao_encontrado', 'outro': 'numero_chaves_invalido'}
dic = valida_questao(questao)
if dic != saida:
    print('o jogo não pode ser iniciado!')
else :
    ...
    # questões fáceis 
        ...
        if dinheiro >= 10000 and dinheiro < 100000 :
            ...
            questao_jogada_texto = questao_para_texto(nova_questao ,numero )
            usadas.append(questao_sorteada)
            print(questao_jogada_texto)
